...
export const Badge = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex space-x-2 items-center z-10 rounded-full bg-transparent py-2 w-48 lg:w-32 md:w-36 px-10 lg:px-3 md:px-6 ring-1 ring-white/10 ">
