        ...
        {products.map((product: Product, idx: number) => (
          ...
          >
            <Link
              ...
              key={product.href}
              className="group block lg:flex flex-col md:flex-row space-y-4 md:space-y-5 md:space-x-4 hover:bg-gray-50 rounded-2xl transition duration-200 pt-4"
            >
              <Image
                ...
                height="200"
                width="200"
                className="rounded-md w-full lg:w-52"
              />
              <div className="flex flex-col justify-between">
                ...
                <div className="grid grid-cols-3 lg:grid-cols-6 md:grid-cols-4 lg:space-x-2 md:mb-1 mt-2 md:mt-0">
