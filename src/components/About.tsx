    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Shittu Faruq - a passionate developer,
        ...
        <Paragraph className="mt-4">
          ...
          that aesthetics and usability go hand in hand. I have keen eye to details and awesome
          design which ensures that every project I undertake not only works
        ...
        <Paragraph className=" mt-4">
          Join me on this journey of bytes, logic and creativity,
